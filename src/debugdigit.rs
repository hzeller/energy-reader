...
pub fn debug_print_digits(haystack: &GrayImage,
			  digits: &[GrayImage],
			  max_digit_width: u32,
			  digit_scores: &[Vec<f32>],
			  digit_positions: &[DigitPos]) -> GrayImage {
	...
	image::imageops::overlay(&mut output, &visualize,
	...
	image::imageops::overlay(&mut output, digit_pic,
